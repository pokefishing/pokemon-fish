...
enum
{
    ...
    OBJ_EVENT_GFX_FISHERMANGEN6_M,
    OBJ_EVENT_GFX_FISHERMANGEN5_M,
    OBJ_EVENT_GFX_FISHERMANGEN1_M,
    OBJ_EVENT_GFX_SAILORGEN4_M,
    OBJ_EVENT_GFX_FISHERMAN_HYO,
    OBJ_EVENT_GFX_SAILOR_HYO,
    OBJ_EVENT_GFX_SWIMMER_M_HYO,
    OBJ_EVENT_GFX_SWIMMER_F_HYO,
    OBJ_EVENT_GFX_TUBER_F_HYO,
    OBJ_EVENT_GFX_TUBER_M_HYO,
    OBJ_EVENT_GFX_TUBER_M_SWIMMING_HYO,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_FISHERMANGEN6_M            0x1134
#define OBJ_EVENT_PAL_TAG_FISHERMANGEN5_M            0x1135
#define OBJ_EVENT_PAL_TAG_FISHERMANGEN1_M            0x1136
#define OBJ_EVENT_PAL_TAG_SAILORGEN4_M               0x1137
